...
var DockWindows = (function (_super) {
    ...
    DockWindows.prototype.render = function () {
        ...
        }, React.DOM.div({ className: 'btn-toolbar pull-left' }, React.DOM.div({ className: 'btn-group btn-toggle' }, this.getButtons())));
    };
    return DockWindows;
...
var DockWindow = (function (_super) {
    ...
    DockWindow.prototype.render = function () {
        ...
        }), React.createElement(DockWindows, { selected: this.state.selected, setSelected: this.selectWindow.bind(this), panes: this.props.panes }), this.getWindows());
    };
    return DockWindow;
})(react_client_component_1.ReactClientComponent);
