...
var composite_client_v1_1 = require("./composite-client-v1");
var composite_client_base_1 = require("./composite-client-base");
var ObservationClientV2 = (function (_super) {
    __extends(ObservationClientV2, _super);
    function ObservationClientV2(clients) {
        if (clients === void 0) { clients = []; }
        _super.call(this, clients);
        this.v1 = new composite_client_v1_1.ObservationClientV1(clients.map(function (z) { return z.v1; }));
    ...
    ObservationClientV2.prototype.add = function (client) {
        composite_client_base_1.ObservationClientBase.prototype.add.call(this, client);
        this.v1.add(client.v1);
    };
    ObservationClientV2.prototype.remove = function (client) {
        composite_client_base_1.ObservationClientBase.prototype.remove.call(this, client);
        this.v1.remove(client.v1);
    };
    ObservationClientV2.prototype.removeAll = function () {
        composite_client_base_1.ObservationClientBase.prototype.removeAll.call(this);
        this.v1.removeAll();
    };
    return ObservationClientV2;
})(composite_client_base_1.ObservationClientBase);
exports.ObservationClientV2 = ObservationClientV2;
var CombinationClientV2 = (function (_super) {
    __extends(CombinationClientV2, _super);
    function CombinationClientV2(clients) {
        if (clients === void 0) { clients = []; }
        _super.call(this, clients);
    ...
    return CombinationClientV2;
})(composite_client_base_1.CombinationClientBase);
exports.CombinationClientV2 = CombinationClientV2;
