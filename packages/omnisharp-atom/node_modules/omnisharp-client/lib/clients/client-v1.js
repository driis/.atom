...
var ClientV1 = (function (_super) {
    ...
    ClientV1.prototype.updatebuffer = function (request, options) {
        chai_1.assert.isNotNull(request.FileName, 'request.FileName must not be null');
        chai_1.assert.isNotNull(request.Buffer, 'request.Buffer must not be null');
    ...
    ClientV1.prototype.changebuffer = function (request, options) {
        chai_1.assert.isNotNull(request.FileName, 'request.FileName must not be null');
        chai_1.assert.isNotNull(request.NewText, 'request.NewText must not be null');
        chai_1.assert.isNotNull(request.StartLine, 'request.StartLine must not be null');
        chai_1.assert.isAbove(request.StartLine, this._lowestIndexValue - 1, "request.StartLine must be greater than or equal to " + this._lowestIndexValue);
        chai_1.assert.isNotNull(request.StartColumn, 'request.StartColumn must not be null');
        chai_1.assert.isAbove(request.StartColumn, this._lowestIndexValue - 1, "request.StartColumn must be greater than or equal to " + this._lowestIndexValue);
        chai_1.assert.isNotNull(request.EndLine, 'request.EndLine must not be null');
        chai_1.assert.isAbove(request.EndLine, this._lowestIndexValue - 1, "request.EndLine must be greater than or equal to " + this._lowestIndexValue);
        chai_1.assert.isNotNull(request.EndColumn, 'request.EndColumn must not be null');
        chai_1.assert.isAbove(request.EndColumn, this._lowestIndexValue - 1, "request.EndColumn must be greater than or equal to " + this._lowestIndexValue);
    ...
    ClientV1.prototype.formatAfterKeystroke = function (request, options) {
        chai_1.assert.isNotNull(request.FileName, 'request.FileName must not be null');
        chai_1.assert.isNotNull(request.Line, 'request.Line must not be null');
        chai_1.assert.isAbove(request.Line, this._lowestIndexValue - 1, "request.Line must be greater than or equal to " + this._lowestIndexValue);
        chai_1.assert.isNotNull(request.Column, 'request.Column must not be null');
        chai_1.assert.isAbove(request.Column, this._lowestIndexValue - 1, "request.Column must be greater than or equal to " + this._lowestIndexValue);
        chai_1.assert.isNotNull(request.Character || request.Char, 'request.Character || request.Char must not be null');
    ...
    ClientV1.prototype.autocomplete = function (request, options) {
        ...
        chai_1.assert.isNotNull(request.Column, 'request.Column must not be null');
        chai_1.assert.isAbove(request.Column, this._lowestIndexValue - 1, "request.Column must be greater than or equal to " + this._lowestIndexValue);
        chai_1.assert.isNotNull(request.WordToComplete, 'request.WordToComplete must not be null');
    ...
    ClientV1.prototype.findsymbols = function (request, options) {
        ...
        chai_1.assert.isNotNull(request.Filter, 'request.Filter must not be null');
    ...
    ClientV1.prototype.rename = function (request, options) {
        ...
        chai_1.assert.isNotNull(request.Column, 'request.Column must not be null');
        chai_1.assert.isAbove(request.Column, this._lowestIndexValue - 1, "request.Column must be greater than or equal to " + this._lowestIndexValue);
        chai_1.assert.isNotNull(request.RenameTo, 'request.RenameTo must not be null');
    ...
    ClientV1.prototype.filesChanged = function (request, options) {
        chai_1.assert.isNotNull(request, 'request must not be null');
    ...
    ClientV1.prototype.projects = function (options) {
        return this.request("projects", {}, options);
    };
    ClientV1.prototype.projectsPromise = function (options) {
    ...
    ClientV1.prototype.runcodeaction = function (request, options) {
        ...
        chai_1.assert.isNotNull(request.Column, 'request.Column must not be null');
        chai_1.assert.isAbove(request.Column, this._lowestIndexValue - 1, "request.Column must be greater than or equal to " + this._lowestIndexValue);
        chai_1.assert.isNotNull(request.CodeAction, 'request.CodeAction must not be null');
        chai_1.assert.isAbove(request.CodeAction, this._lowestIndexValue - 1, "request.CodeAction must be greater than or equal to " + this._lowestIndexValue);
    ...
    ClientV1.prototype.gettestcontext = function (request, options) {
        ...
        chai_1.assert.isNotNull(request.Column, 'request.Column must not be null');
        chai_1.assert.isAbove(request.Column, this._lowestIndexValue - 1, "request.Column must be greater than or equal to " + this._lowestIndexValue);
        chai_1.assert.isNotNull(request.Type, 'request.Type must not be null');
        chai_1.assert.isAbove(request.Type, this._lowestIndexValue - 1, "request.Type must be greater than or equal to " + this._lowestIndexValue);
