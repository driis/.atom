...
var ClientV2 = (function (_super) {
    ...
    ClientV2.prototype.getcodeactions = function (request, options) {
        ...
        if (!request.Selection) {
            ...
            chai_1.assert.isNotNull(request.Selection.Start.Line, 'request.Selection.Start.Line must not be null');
            chai_1.assert.isAbove(request.Selection.Start.Line, this._lowestIndexValue - 1, "request.Selection.Start.Line must be greater than or equal to " + this._lowestIndexValue);
            chai_1.assert.isNotNull(request.Selection.Start.Column, 'request.Selection.Start.Column must not be null');
            chai_1.assert.isAbove(request.Selection.Start.Column, this._lowestIndexValue - 1, "request.Selection.Start.Column must be greater than or equal to " + this._lowestIndexValue);
            chai_1.assert.isNotNull(request.Selection.End.Line, 'request.Selection.End.Line must not be null');
            chai_1.assert.isAbove(request.Selection.End.Line, this._lowestIndexValue - 1, "request.Selection.End.Line must be greater than or equal to " + this._lowestIndexValue);
            chai_1.assert.isNotNull(request.Selection.End.Column, 'request.Selection.End.Column must not be null');
            chai_1.assert.isAbove(request.Selection.End.Column, this._lowestIndexValue - 1, "request.Selection.End.Column must be greater than or equal to " + this._lowestIndexValue);
        }
    ...
    ClientV2.prototype.runcodeaction = function (request, options) {
        chai_1.assert.isNotNull(request.FileName, 'request.FileName must not be null');
        chai_1.assert.isNotNull(request.Identifier, 'request.Identifier must not be null');
        if (!request.Selection) {
            chai_1.assert.isNotNull(request.Line, 'request.Line must not be null');
            chai_1.assert.isAbove(request.Line, this._lowestIndexValue - 1, "request.Line must be greater than or equal to " + this._lowestIndexValue);
            chai_1.assert.isNotNull(request.Column, 'request.Column must not be null');
