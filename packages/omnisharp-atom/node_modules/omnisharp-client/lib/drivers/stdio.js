...
var StdioDriver = (function () {
    function StdioDriver(_a) {
        var _this = this;
        var projectPath = _a.projectPath, debug = _a.debug, serverPath = _a.serverPath, findProject = _a.findProject, logger = _a.logger, timeout = _a.timeout;
        this._seq = 1;
    ...
    StdioDriver.prototype.connect = function (_a) {
        var _this = this;
        var projectPath = _a.projectPath, findProject = _a.findProject;
        ...
        if (win32) {
            ...
            var serverArguments = [path_1.join(__dirname, "../stdio/child.js"), "--serverPath", this._serverPath, "--projectPath", projectPath];
            this._process = child_process_1.spawn(process.execPath, serverArguments, { env: env });
        }
        else {
            var serverArguments = ["--stdio", "-s", this._projectPath, "--hostPID", process.pid];
